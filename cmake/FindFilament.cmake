...
find_library(FilamentImage_LIBRARY NAMES image PATHS "${Filament_LIB_DIR}/" NO_DEFAULT_PATH)
...
set(Filament_RESGEN ${Filament_DIR}/bin/resgen)
set(Filament_CMGEN  ${Filament_DIR}/bin/cmgen)
...
find_package_handle_standard_args(Filament
  REQUIRED_VARS Filament_INCLUDE_DIRS Filament_LIBRARY Filament_RESGEN Filament_CMGEN Filament_MATC)
